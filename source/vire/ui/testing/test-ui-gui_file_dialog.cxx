//! \file  vire/user/testing/test-ui-gui_file_dialog.cxx
...
int main(int /* argc_ */, char ** /* argv_ */)
{
  ...
  try {
    std::clog << "Test program for the 'vire::ui::gui_file_dialog' class."
              << std::endl;
...
void test_1()
{
  ...
  vire::ui::gui_file_dialog dialog;
  dialog.set_title("File selector");
...
void test_2()
{
  ...
  vire::ui::gui_file_dialog dialog;
  dialog.set_title("Directory selector");

//! \file  vire/user/testing/test-ui-tui_integer_dialog.cxx
//! \brief Vire user text user interface integer dialog
//
...
int main(int /* argc_ */, char ** /* argv_ */)
{
  ...
  try {
    std::clog << "Test program for the 'vire::ui::tui_integer_dialog' class."
              << std::endl;
...
void test_1()
{
  ...
  vire::ui::tui_integer_dialog dialog;

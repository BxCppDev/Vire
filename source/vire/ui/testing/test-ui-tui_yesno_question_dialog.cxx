//! \file  vire/user/testing/test-ui-tui_yesno_question_dialog.cxx
//! \brief Vire user text user interface yes/no question dialog
//
...
int main(int /* argc_ */, char ** /* argv_ */)
{
  ...
  try {
    std::clog << "Test program for the 'vire::ui::tui_yesno_question_dialog' class."
              << std::endl;
...
void test_1()
{
  ...
  vire::ui::tui_yesno_question_dialog dialog;
  dialog.set_title("Set a flag");

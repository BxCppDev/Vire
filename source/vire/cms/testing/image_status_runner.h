      ...
      struct image_status_runner
      {
        ...
        void operator()()
        {
         std::default_random_engine generator(_seed_);
          ...
          std::cerr << "status_runner run stopped.\n";
          return;
        }

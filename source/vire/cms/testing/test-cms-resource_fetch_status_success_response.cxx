//! \file cms/testing/test-cms-resource_fetch_status_success_response.cxx
//
...
int main( int argc_, char * argv_[])
{
  ...
  try {

    {
      ...
      vire::cms::resource_fetch_status_success_response r;
      r.set_status(rsr);
      r.tree_dump(std::clog, "Resource fetch status success response: ");
      std::clog << std::endl;
    }

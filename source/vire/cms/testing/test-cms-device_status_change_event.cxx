//! \file cms/testing/test-cms-device_status_change_event.cxx
//
...
int main( int argc_, char * argv_[])
{
  ...
  try {

    {
      ...
      rsr.set_path("SuperNEMO:/Demonstrator/CMS/Coil");
      rsr.set_timestamp(vire::time::now());
      rsr.set_missing();

      vire::cms::device_status_change_event rsce;
      rsce.set_timestamp(vire::time::now());
      rsce.set_status(rsr);
      rsce.tree_dump(std::clog, "Device status change event: ");
      std::clog << std::endl;
    }

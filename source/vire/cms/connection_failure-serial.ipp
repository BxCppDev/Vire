//! \file  vire/cms/connection_failure-serial.ipp
...
#ifndef VIRE_CMS_CONNECTION_FAILURE_SERIAL_IPP
#define VIRE_CMS_CONNECTION_FAILURE_SERIAL_IPP
...
namespace vire {
  ...
  namespace cms {
                                       ...
                                       const unsigned int /* version_*/)
    {
      ...
      if (_error_type_id_.match("vire::cms::unknown_resources_error")) {
...
#endif // VIRE_CMS_CONNECTION_FAILURE_SERIAL_IPP

//! \file  vire/cms/resource_status_change-serial.ipp
//! \brief Resource status change serialization
//
...
#ifndef VIRE_CMS_RESOURCE_STATUS_CHANGE_SERIAL_IPP
...
namespace vire {
  ...
  namespace cms {
    ...
    void resource_status_change::serialize(Archive & archive_, const unsigned int /* version_*/)
    {
...
#endif // VIRE_CMS_RESOURCE_STATUS_CHANGE_SERIAL_IPP

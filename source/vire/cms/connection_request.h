//! \file  vire/cms/connection_request.h
...
#ifndef VIRE_CMS_CONNECTION_REQUEST_H
#define VIRE_CMS_CONNECTION_REQUEST_H
...
namespace vire {
  ...
  namespace cms {
    ...
    ///
    /// Type id: "vire::cms::connection_request", version "1.0"
    ///
    /// @code JSON
    /// {
    ///   "setup_id": {
...
BOOST_CLASS_EXPORT_KEY2(vire::cms::connection_request,

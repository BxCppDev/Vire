//! \file vire/cmsserver/sequence_use_case.cc
//
...
// Ourselves:
#include <vire/cmsserver/sequence_use_case.h>

namespace vire {

  namespace cmsserver {

    sequence_use_case::sequence_use_case(const uint32_t flags_)
    ...
    // virtual
    sequence_use_case::~sequence_use_case()
    {
      return;
    }
    
    void sequence_use_case::_set_defaults_()
    {
      return;
    }

    void sequence_use_case::set_duration(const boost::posix_time::time_duration & duration_)
    {
    ...
    const boost::posix_time::time_duration & sequence_use_case::get_duration() const
    {
      return _duration_;
    }
                     
    void sequence_use_case::_at_initialize_(const datatools::properties & config_)
    {
    ...
    void sequence_use_case::_at_finalize_()
    {
      DT_LOG_TRACE_ENTERING(get_logging_priority());
      vire::time::invalidate(_duration_);
      DT_LOG_TRACE_EXITING(get_logging_priority());
    ...
    // virtual
    std::shared_ptr<uc_time_constraints> sequence_use_case::_build_time_constraints()
    {
      DT_LOG_TRACE_ENTERING(get_logging_priority());
    ...
    void sequence_use_case::_at_run_prepare_()
    {
      DT_LOG_TRACE_ENTERING(get_logging_priority());
    ...
    void sequence_use_case::_at_run_functional_work_loop_iteration_()
    {
      DT_LOG_TRACE_ENTERING(get_logging_priority());
      DT_LOG_TRACE_EXITING(get_logging_priority());
      return;
    ...
    // virtual
    void sequence_use_case::print_tree(std::ostream & out_,

// vire/resource/base_resource_builder.cc
//
...
namespace vire {
  ...
  namespace resource {
    ...
    void base_resource_builder::set_logging_priority(datatools::logger::priority p_)
    {
      _logging_priority = p_;
      return;
    }

    datatools::logger::priority base_resource_builder::get_logging_priority() const
    {
    ...
    const ::vire::resource::manager & base_resource_builder::get_resource_manager() const
    {
    ...
    ::vire::resource::manager & base_resource_builder::_grab_resource_manager()
    {
      return *_resource_manager_;
    }

    void base_resource_builder::initialize_simple()
    {

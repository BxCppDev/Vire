//! \file  vire/resource/base_role_builder.h
//! \brief Vire role builder for the resource manager
//
...
#ifndef VIRE_RESOURCE_BASE_ROLE_BUILDER_H
#define VIRE_RESOURCE_BASE_ROLE_BUILDER_H
...
namespace vire {
  ...
  namespace resource {
    ...
    //! \brief Base builder of roles from an external source
    class base_role_builder
    {
    public:
...
DR_CLASS_INIT(vire::resource::base_role_builder);
#endif // Q_MOC_RUN

#endif // VIRE_RESOURCE_BASE_ROLE_BUILDER_H

//! \file  vire/inspector/shell_find_devices_command.h
...
#ifndef VIRE_INSPECTOR_SHELL_FIND_DEVICES_COMMAND_H
#define VIRE_INSPECTOR_SHELL_FIND_DEVICES_COMMAND_H
...
namespace vire {
  ...
  namespace inspector {
    ...
    struct shell_find_devices_command
      : public datatools::ui::const_target_command<inspector_shell>
    {
      shell_find_devices_command(const inspector_shell &);

      virtual ~shell_find_devices_command();
...
#endif // VIRE_INSPECTOR_SHELL_FIND_DEVICES_COMMAND_H

//! \file  vire/cmslapp/disconnection_failure.h
...
#ifndef VIRE_CMSLAPP_DISCONNECTION_FAILURE_H
#define VIRE_CMSLAPP_DISCONNECTION_FAILURE_H
...
namespace vire {
  ...
  namespace cmslapp {
    ...
    ///
    /// Type id: "vire::cmslapp::disconnection_failure", version "1.0"
    ///
    /// @code JSON
    /// {
    ///   "error_type_id" : {
...
BOOST_CLASS_EXPORT_KEY2(vire::cmslapp::disconnection_failure,"vire::cmslapp::disconnection_failure")

// Bind the C++ class to a specific protobuf message class
#include <bayeux/protobuftools/protobuf_utils.h>
BXPROTOBUFTOOLS_CLASS_BIND_TO_REGISTERED_PROTOBUF(vire::cmslapp::disconnection_failure,
						  "vire::cmslapp::disconnection_failure")

#endif // VIRE_CMSLAPP_DISCONNECTION_FAILURE_H

// vire/cmslapp/disconnection_request.cc
//
...
#include "vire/cmslapp/DisconnectionRequest.pb.h"
BXPROTOBUFTOOLS_REGISTER_CLASS("vire::cmslapp::disconnection_request",
                               vire::cmslapp::DisconnectionRequest)

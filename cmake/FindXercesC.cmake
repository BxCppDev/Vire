...
# Adapted from : cmake/3.8.1/share/cmake/Modules/FindXercesC.cmake
...
if (XERCESC_INCLUDE_DIR)
  if (NOT XERCESC_ROOT)
    get_filename_component(XERCESC_ROOT "${XERCESC_INCLUDE_DIR}" PATH)
  endif()
endif()
...
if(PROTOBUF_INCLUDE_DIR STREQUAL "")
  ...
  set(XercesC_LIBRARIES NOTFOUND)
endif()

  if(CMAKE_SIZEOF_VOID_P EQUAL 8)
    set(_XERCESC_ARCH_DIR 64/)
  endif()
...
if(NOT XercesC_LIBRARY)
  ...
  find_library(XercesC_LIBRARY
	       ...
	       PATH_SUFFIXES lib lib${_XERCESC_ARCH_DIR}
	       HINTS ${XERCESC_ROOT}
	       ENV XERCESC_ROOT
